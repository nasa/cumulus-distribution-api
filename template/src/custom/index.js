...
module.exports.brandNames = {
  desktop: 'Cumulus Distribution API Documentation',
  tablet: 'Cumulus Dist API Docs',
  mobile: 'Dist API Docs'
};
 ...
 */
module.exports.backLink = 'Back to Cumulus Distribution Docs';
